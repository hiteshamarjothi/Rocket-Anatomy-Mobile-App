        ...
        <SafeAreaView style={styles.container}>
            ...
            {/* NavBar */}
                ...
                <View style={styles.mainContainer}>
                    <Image style={styles.fairingImage} source={require('../../assets/FalconHeavyLandingLegs.png')}/>
                </View>

                {/* Description */}
                <View style={styles.descriptionContainer}>
                    <Text style={styles.descriptionHeader}>Description </Text>
                    <Text style={styles.description}>The First Stage of the rocket is equipped with 12 landing legs made of carbon fibre and aluminum honeycomb. They deploy just after landing and are stowed at the base of the vehicle placed symmetrically around the base of the rocket. </Text>
                    <Text style={styles.statsHeader}>Statistics</Text>
                    <View style={styles.statsContainer}>
                        <Text style={styles.stats}>Number of Legs:</Text>
                        <Text style={styles.statsContent}>12</Text>
                    </View>
