...
function Falcon9Interstage(props) {
    ...
    const storeData = async (value) => {
        try {
          ...
          await AsyncStorage.setItem('@storage_Key_FalconHeavyInterstage', jsonValue)
        } catch (e) {
          // saving error
        }
      }
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.componentContainer} >
                <View style={styles.componentHeader}>
                    ...
                    <Text style={styles.componentHeaderSubText}>• Falcon Heavy Interstage</Text>
                </View>
                <View style={styles.componentWrapper}>
                    <TouchableOpacity style={styles.fairingComponentItem}  onPress={() => navigation.navigate('FalconHeavyGrid')}>
