        ...
        <SafeAreaView style={styles.container}>
            ...
            {/* NavBar */}
                ...
                style={({ pressed }) => [
                    ...
                    onPress={() => navigation.navigate('FalconHeavyInterstage')}
                        >
                ...
                <View style={styles.headerContainer}>
                    ...
                    <Text style={styles.subHeader}>•  F.H. Interstage</Text>
                </View>

                {/* Main */}
                <View style={styles.mainContainer}>
                    <Image style={styles.fairingImage} source={require('../../assets/GridFins.png')}/>
                </View>

                {/* Description */}
                <View style={styles.descriptionContainer}>
                    <Text style={styles.descriptionHeader}>Description </Text>
                    <Text style={styles.description}>On re-entry, the Falcon Heavy's hyper-sonic grid fins help to orient the rocket by moving the centre of pressure.</Text>
                    <Text style={styles.statsHeader}>Statistics</Text>
                    <View style={styles.statsContainer}>
                        <Text style={styles.stats}>Number of Hypersonic Grid Fins:</Text>
