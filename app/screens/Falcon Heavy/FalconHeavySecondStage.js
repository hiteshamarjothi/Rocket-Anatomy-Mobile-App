...
function Falcon9SecondStage(props) {
    ...
    const storeData = async (value) => {
        try {
          ...
          await AsyncStorage.setItem('@storage_Key_FalconHeavySecondStage', jsonValue)
        } catch (e) {
          // saving error
        }
      }
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.descriptionContainer}>
                ...
                <View style={styles.descriptionSection}>
                    <View style={styles.descriptionWrapper}>
                        ...
                        <Text style={styles.description}>The Second stage of the Falcon Heavy delivers the payload of the rocket to the to the desired orbit. Explore below for engine specifications. </Text>
                    </View>
            ...
            <View style={styles.componentContainer}>
                <View style={styles.componentHeader}>
                    ...
                    <Text style={styles.componentHeaderSubText}>• F.H.Second Stage</Text>
                </View>
                <View style={styles.componentWrapper}>
                    <TouchableOpacity style={styles.fairingComponentItem} onPress={() => navigation.navigate('FalconHeavySSEngine')}>
