        ...
        <SafeAreaView style={styles.container}>
            ...
            {/* NavBar */}
                ...
                style={({ pressed }) => [
                    ...
                    onPress={() => navigation.navigate('FalconHeavySecondStage')}
                        >
                ...
                <View style={styles.headerContainer}>
                    ...
                    <Text style={styles.subHeader}>•  F.H. Second Stage</Text>
                </View>

                {/* Main */}
                <View style={styles.mainContainer}>
                    <Image style={styles.fairingImage} source={require('../../assets/SecondStage.png')}/>
                </View>

               {/* Description */}
               <View style={styles.descriptionContainer}>
                    <Text style={styles.descriptionHeader}>Description </Text>
                    <Text style={styles.description}>Powered by a single Merlin Vacuum Engine, the second stage of the Falcon Heavy delivers the payload of the rocket to the desired orbit. The engine ignites a few seconds after the stage separation and can be restarted multiple times to place multiple payloads into different earth orbits. </Text>
                    <Text style={styles.statsHeader}>Statistics</Text>
                    <View style={styles.statsContainer}>
                        <Text style={styles.stats}>Burn Time:</Text>
                        <Text style={styles.statsContent}>397 sec</Text>
                        <Text style={styles.stats}>Thrust:</Text>
                        <Text style={styles.statsContent}>981 kN</Text>
                    </View>
