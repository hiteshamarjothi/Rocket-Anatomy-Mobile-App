...
function Falcon9Payload(props) {
    ...
    const storeData = async (value) => {
        try {
          ...
          await AsyncStorage.setItem('@storage_Key_FalconHeavyPayload', jsonValue)
        } catch (e) {
          // saving error
        }
      }
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.descriptionContainer}>
                ...
                <View style={styles.descriptionSection}>
                    <View style={styles.descriptionWrapper}>
                        ...
                        <Text style={styles.description}>The payload section of Falcon Heavy is designed to carry large cargo. It consists of multiple components that ensure the safe transport of mission-critical items or crew.  </Text>
                    </View>
            ...
            <View style={styles.componentContainer}>
                <View style={styles.componentHeader}>
                    ...
                    <Text style={styles.componentHeaderSubText}>• Falcon Heavy Payload</Text>
                </View>
                <View style={styles.componentWrapper} >
                    <TouchableOpacity style={styles.fairingComponentItem} onPress={() => navigation.navigate('FalconHeavyFairing')}>
                    ...
                    <TouchableOpacity style={styles.dragonComponentItem} onPress={() => navigation.navigate('FalconHeavyDragon')}>
