...
function Falcon9Payload(props) {
    ...
    const progress = (fairingChecked + dragonTrunkChecked) / 2 * 100;
    ...
    const storeData = async (value) => {
        try {
          ...
          await AsyncStorage.setItem('@storage_Key_Payload', jsonValue)
        } catch (e) {
          // saving error
        }
      }
      ...
      const getData = async () => {
        try {
          const jsonValue = await AsyncStorage.getItem('@storage_Key_Payload')
    ...
    useEffect(() => {
        storeData({ fairingChecked, dragonTrunkChecked });
    }, [fairingChecked, dragonTrunkChecked]);
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.descriptionContainer}>
                ...
                <View style={styles.descriptionSection}>
                    <View style={styles.descriptionWrapper}>
                        <Animated.Text style={styles.payloadHeading} sharedTransitionTag="tag" >Payload</Animated.Text>
                        <Text style={styles.description}>The top of falcon 9. Within the payload section, there are 2 main components. This is where the items or people for the purpose of a mission are located.  </Text>
                    </View>
                    <View style={styles.payloadImage}>
                        <Image style={styles.payloadImageSource} source={require('../../assets/flacon9Crop.png')}/>
                    </View>
                </View>
            ...
            <View style={styles.componentContainer}>
                <View style={styles.componentHeader}>
                    ...
                    <Text style={styles.componentHeaderSubText}>• Falcon 9 Payload</Text>
                </View>
                <View style={styles.componentWrapper} >
                    <TouchableOpacity style={styles.fairingComponentItem} onPress={() => navigation.navigate('FairingPage')}>
                        <View style={styles.fairingWrapper}>
                            <View style={styles.fairingIcon}>
                                <Feather name="box" size={45} color="white" style={styles.icon}/>
                            </View>
                            <Text style={styles.header}>Fairing</Text>   
                        </View>

                        <View style={styles.negativeSpace}/>
                        <TouchableOpacity onPress={() => setFairingChecked(!fairingChecked)} style={styles.fairingTickBox} activeOpactity={100}>
                            <View style={fairingChecked ? styles.checkedCircle : styles.fairingCircle}>
                                        {fairingChecked && <Feather name="check" size={24} color="white" />}
                            </View>
                        </TouchableOpacity>
                       
                            
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.dragonComponentItem} onPress={() => navigation.navigate('DragonPage')}>
                        <View style={styles.dragonWrapper}>
                                <View style={styles.fairingIcon}>
                                    <Feather name="box" size={45} color="white" style={styles.icon}/>
                                </View>
                                <Text style={styles.header}>Dragon Trunk</Text>   
                        </View>

                            
                            
                        <TouchableOpacity onPress={() => setDragonTrunkChecked(!dragonTrunkChecked)} style={styles.dragonTickBox}>
                        <View style={dragonTrunkChecked ? styles.checkedCircle : styles.fairingCircle}>
                                        {dragonTrunkChecked && <Feather name="check" size={24} color="white" />}
                            </View>
                        </TouchableOpacity>
