...
function Falcon9Interstage(props) {
    ...
    const progress = (gridFinChecked) / 1 * 100;
    ...
    const storeData = async (value) => {
        try {
          ...
          await AsyncStorage.setItem('@storage_Key_Interstage', jsonValue)
        } catch (e) {
          // saving error
        }
      }
      ...
      const getData = async () => {
        try {
          const jsonValue = await AsyncStorage.getItem('@storage_Key_Interstage')
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.descriptionContainer}>
                ...
                <View style={styles.descriptionSection}>
                    <View style={styles.descriptionWrapper}>
                        <Text style={styles.payloadHeading}>Interstage</Text>
                    ...
                    <View style={styles.payloadImage}>
                        <Image style={styles.payloadImageSource} source={require('../../assets/Interstage.png')}/>
                    </View>
                </View>

                <View style={styles.progressBar}>
                    <View style={styles.progressBarContainer}>
                        <Animated.View style={[styles.inner, { width: widthAnim2.interpolate({
                                inputRange: [0, 100],
                                outputRange: ['0%', '100%'],
                            })}]} />
                    </View>
            ...
            <View style={styles.componentContainer} >
                <View style={styles.componentHeader}>
                    ...
                    <Text style={styles.componentHeaderSubText}>• Falcon 9 Interstage</Text>
                </View>
                <View style={styles.componentWrapper}>
                    <TouchableOpacity style={styles.fairingComponentItem}  onPress={() => navigation.navigate('GridFins')}>
                        <View style={styles.fairingWrapper}>
                            <View style={styles.fairingIcon}>
                                <Feather name="box" size={45} color="white" style={styles.icon}/>
                            </View>
                            <Text style={styles.header}>Grid Fins</Text>   
                        </View>

                        <View style={styles.negativeSpace}/>
                        <TouchableOpacity onPress={() => setGridFinChecked(!gridFinChecked)} style={styles.fairingTickBox} activeOpactity={100}>
                            <View style={gridFinChecked ? styles.checkedCircle : styles.fairingCircle}>
                                        {gridFinChecked && <Feather name="check" size={24} color="white" />}
                            </View>
                        </TouchableOpacity>
...
export default Falcon9Interstage;
