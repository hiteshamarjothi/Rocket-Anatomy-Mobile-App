        ...
        <SafeAreaView style={styles.container}>
            ...
            {/* NavBar */}
                ...
                style={({ pressed }) => [
                    ...
                    onPress={() => navigation.navigate('Falcon9Interstage')}
                        >
                ...
                <View style={styles.headerContainer}>
                    ...
                    <Text style={styles.subHeader}>•  Falcon 9 Interstage</Text>
                </View>
                ...
                <View style={styles.descriptionContainer}>
                    ...
                    <Text style={styles.description}>On re-entry, the Falcon 9’s hyper-sonic grid fins help to orient the rocket by moving the centre of pressure.</Text>
