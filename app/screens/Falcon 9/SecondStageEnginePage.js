        ...
        <SafeAreaView style={styles.container}>
            ...
            {/* NavBar */}
                ...
                style={({ pressed }) => [
                    ...
                    onPress={() => navigation.navigate('Falcon9SecondStage')}
                        >
                ...
                <View style={styles.headerContainer}>
                    ...
                    <Text style={styles.subHeader}>•  Falcon 9 Second Stage</Text>
                </View>
               ...
               <View style={styles.descriptionContainer}>
                    ...
                    <Text style={styles.description}>Powered by a single Merlin Vacuum Engine, the second stage of the Falcon 9 delivers the payload of the rocket to the desired orbit. The engine ignites a few seconds after the stage separation and can be restarted multiple times to place multiple payloads into different earth orbits. </Text>
