...
function Falcon9FirstStage(props) {
    ...
    const storeData = async (value) => {
        try {
          ...
          await AsyncStorage.setItem('@storage_Key_FirstStage', jsonValue)
        } catch (e) {
          // saving error
        }
      }
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.componentContainer}>
                <View style={styles.componentHeader}>
                    ...
                    <Text style={styles.componentHeaderSubText}>• Falcon 9 First Stage</Text>
                </View>
                <View style={styles.componentWrapper}>
                    <TouchableOpacity style={styles.fairingComponentItem} onPress={() => navigation.navigate('FirstStageEngine')}>
                    ...
                    <TouchableOpacity style={styles.dragonComponentItem} onPress={() => navigation.navigate('LandingLegs')}>
