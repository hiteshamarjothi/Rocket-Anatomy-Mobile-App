...
//-----------------------------------------------------------------------------------------------
    ...
    const getData4 = async () => {
        try {
            const jsonValue = await AsyncStorage.getItem('@storage_Key_FirstStage')
            return jsonValue != null ? JSON.parse(jsonValue) : null;
        } catch(e) {
            // error reading value
        }
    ...
    <Animated.View style={{...styles.container, opacity: opacityValue}}>
            ...
            <View style={styles.main}>
                <View style={styles.section1}>
                    <Text style={styles.rocketTitle}>The Falcon 9</Text>
                    <Text style={styles.rocketDescription}>
                        The Falcon 9 by SpaceX is a next generation rocket/spaceship that is one of the first reusable 
                        outer space rockets because of its self landing capabilities. 
                    </Text>
                </View>
                <View style={styles.section2}>
                    <View style={styles.leftColumn}>
                        <Image style={styles.falcon9Image} source={require('../../assets/falcon9Image.png')} />
                    </View>
                    <View style={styles.rightColumn}>

                        <TouchableOpacity style={styles.subSection1} onPress={() => navigation.navigate('Falcon9Payload')}>
                        ...
                        <TouchableOpacity style={styles.subSection1} onPress={() => navigation.navigate('Falcon9Interstage')}>
                        ...
                        <TouchableOpacity style={styles.subSection1} onPress={() => navigation.navigate('Falcon9SecondStage')}>
                        ...
                        <TouchableOpacity style={styles.subSection1} onPress={() => navigation.navigate('Falcon9FirstStage')}>
