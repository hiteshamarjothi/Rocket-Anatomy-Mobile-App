        ...
        <SafeAreaView style={styles.container}>
            ...
            {/* NavBar */}
                ...
                <View style={styles.headerContainer}>
                    ...
                    <Text style={styles.subHeader}>•  Artemis Boosters</Text>
                   
                </View>

                {/* Main */}
                <View style={styles.mainContainer}>
                    <Image style={styles.fairingImage} source={require('../../assets/ArtemisSLSCoreStage.png')}/>
                </View>

                {/* Description */}
                <View style={styles.descriptionContainer}>
                    <Text style={styles.descriptionHeader}>Description </Text>
                    <Text style={styles.description}>The Core Stage of the Artemis 1 SLS rocket is the backbone of the launch vehicle, providing the primary propulsion during the initial phase of flight. It contains the main engines and fuel tanks, which store liquid hydrogen and liquid oxygen propellants.</Text>
                    <Text style={styles.statsHeader}>Statistics </Text>
                    <View style={styles.statsContainer}>
                        <Text style={styles.stats}>Height:</Text>
                        <Text style={styles.statsContent}>64.6 m</Text>
                        <Text style={styles.stats}>Diameter:</Text>
                        <Text style={styles.statsContent}>8.4 m</Text>
                    </View>
                </View>
