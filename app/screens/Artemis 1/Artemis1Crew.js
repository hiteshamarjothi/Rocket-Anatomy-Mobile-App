        ...
        <SafeAreaView style={styles.container}>
            ...
            {/* NavBar */}
                ...
                <View style={styles.mainContainer}>
                    <Image style={styles.fairingImage} source={require('../../assets/Orion.png')}/>
                </View>

                {/* Description */}
                <View style={styles.descriptionContainer}>
                    <Text style={styles.descriptionHeader}>Description </Text>
                    <Text style={styles.description}>This part of the SLS will house the Orion multi-purpose crew vehicle for NASA's planned missions to the lunar surface. The spacecraft consits of a Crew Module (CM) designed by Lockheed Martin and the European Service Module, and manufactued by Airbus </Text>
