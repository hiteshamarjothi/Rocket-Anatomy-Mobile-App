...
function Falcon9SecondStage(props) {
    ...
    const progress = (artemisEngineChecked) / 1 * 100;
    ...
    const storeData = async (value) => {
        try {
          ...
          await AsyncStorage.setItem('@storage_Key_ArtemisEngines', jsonValue)
        } catch (e) {
          // saving error
        }
      }
    ...
    useEffect(() => {
        storeData({ artemisEngineChecked});
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.descriptionContainer}>
                ...
                <View style={styles.descriptionSection}>
                    <View style={styles.descriptionWrapper}>
                        <Text style={styles.payloadHeading}>Engines</Text>
                        <Text style={styles.description}>The engines of the Artemis SLS rocket provide the necessary thrust to propel the rocket into space. Explore below for engine specifications. </Text>
                    </View>
                    <View style={styles.payloadImage}>
                        <Image style={styles.payloadImageSource} source={require('../../assets/Artemis1Engine.png')}/>
                    </View>
                </View>
            ...
            <View style={styles.componentContainer}>
                <View style={styles.componentHeader}>
                    ...
                    <Text style={styles.componentHeaderSubText}>• Artemis Engines</Text>
                </View>
                <View style={styles.componentWrapper}>
                    <TouchableOpacity style={styles.fairingComponentItem} onPress={() => navigation.navigate('Artemis1Engine')}>
                        ...
                        <TouchableOpacity onPress={() => setArtemisEngineChecked(!artemisEngineChecked)} style={styles.fairingTickBox} activeOpactity={100}>
                            <View style={artemisEngineChecked ? styles.checkedCircle : styles.fairingCircle}>
                                        {artemisEngineChecked && <Feather name="check" size={24} color="white" />}
                            </View>
                        </TouchableOpacity>
